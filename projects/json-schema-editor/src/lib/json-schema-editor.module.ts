...
import { MatCardModule, MatSelectModule, MatIconModule, MatSlideToggleModule, MatButtonModule, MatFormFieldModule, MatInputModule } from '@angular/material';
import { FathymSharedModule } from '@lcu/hosting';

@NgModule({
  declarations: [JSONSchemaEditorComponent, JSONSchemaFormControlsComponent],
  imports: [FathymSharedModule, DndModule, FlexLayoutModule, MatButtonModule, MatCardModule, MatFormFieldModule, MatIconModule, MatInputModule, MatSelectModule, MatSlideToggleModule],
